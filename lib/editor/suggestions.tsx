...
import { Suggestion as PreviewSuggestion } from '@/components/common/artifacts/suggestion';
import type { Suggestion } from '@/components/common/artifacts/create-artifact';
import { ArtifactKind } from '@/components/common/artifacts/artifact';
...
export function projectWithPositions(
  ...
  return suggestions.map((suggestion) => {
    ...
    const positions = findPositionsInDoc(doc, originalText);
