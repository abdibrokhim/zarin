...
import { ArrowUp, Stop, ChatCircleText } from '@phosphor-icons/react/dist/ssr';
  ...
  return (
    <Tooltip open={isHovered && !isAnimating}>
      <TooltipTrigger asChild>
        ...
        >
          {selectedTool === description ? <ArrowUp className='size-4' /> : icon}
        </motion.div>
      </TooltipTrigger>
      <TooltipContent
        side="left"
      ...
      <TooltipProvider>
        <Tooltip open={!isAnimating}>
          <TooltipTrigger asChild>
            ...
            >
              {currentLevel === 2 ? <ChatCircleText className='size-4' /> : <ArrowUp className='size-4' />}
            </motion.div>
          </TooltipTrigger>
          <TooltipContent
            side="left"
