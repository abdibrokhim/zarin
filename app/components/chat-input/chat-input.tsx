  ...
  return (
    <div className="relative flex w-full flex-col gap-4">
      ...
      <div className="relative order-2 px-2 pb-3 sm:pb-4 md:order-1">
        <PromptInput
          className="border-primary/70 hover:border-primary bg-primary/5 relative z-10 overflow-hidden border p-0 pb-2 shadow-xs backdrop-blur-xl"
          maxHeight={200}
          value={value}
          onValueChange={onValueChange}
        >
          ...
          <PromptInputTextarea
            ...
            className="mt-2 ml-2 min-h-[44px] text-base leading-[1.3] sm:text-base md:text-base text-foreground"
